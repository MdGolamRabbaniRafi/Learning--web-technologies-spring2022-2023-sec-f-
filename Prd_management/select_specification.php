    ...
    <body>
        ...
        <form method="POST" action="loginCheck.php" enctype="">
            <table border='1'>
               ...
               <tr><td>Login [Admin] [Patients] [Doctors]</td><td>
...
<td><input type="checkbox" name="option[]" value="1"/>Checked
</td>
</tr>
...
<td><input type="checkbox" name="option[]" value="2"/>Checked
</td>
</tr>
...
<td><input type="checkbox" name="option[]" value="3"/>Checked
</td>
</tr>
...
<td><input type="checkbox" name="option[]" value="4"/>Checked
</td>
</tr>
...
<td><input type="checkbox" name="option[]" value="5"/>Checked
</td>
</tr>
<tr></tr>

<tr><td colspan="6"align="right"><input type="submit" name="Back" value="Back"><input type="submit" name="create" value="Create"></td></tr>
